    ...
    private fun startSplashVideo() {
        ...
        try {
            ...
            vv.setOnPreparedListener { mp: MediaPlayer ->
                ...
                // Force video to fill entire screen (stretch if necessary)
                // This removes black bars by stretching the video
                ...
                if (videoWidth > 0 && videoHeight > 0) {
                    ...
                    // Apply scaling to VideoView
                    vv.scaleX = scaleX
                    vv.scaleY = scaleY
                    
                    // Center the video
                    vv.translationX = (screenWidth - videoWidth * scaleX) / 2f
                    vv.translationY = (screenHeight - videoHeight * scaleY) / 2f
                }
