...
class MealRepository(
    ...
    suspend fun initializeSampleData() {
        ...
        val sampleMeals = listOf(
            ...
            // Cloud meals (Firebase Storage - require internet)
            Meal(
                name = "Chicken Tikka",
                type = MealType.LUNCH,
                ...
                carbs = 12,
                fats = 25,
                imageUrl = "meal_images/chicken_tikka_card.png",
                detailImageUrl = "meal_images/chicken_tikka_detail.jpeg",
                isCloudImage = true
            ),
            Meal(
                name = "Shrimp Tacos",
                ...
                carbs = 45,
                fats = 22,
                imageUrl = "meal_images/shrimp_tacos_card.png",
                detailImageUrl = "meal_images/shrimp_tacos_detail.png",
                isCloudImage = true
            )
        )
