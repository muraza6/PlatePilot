    ...
    suspend fun initializeSampleData() {
        ...
        val sampleMeals = listOf(
            ...
            Meal(
                ...
                detailImageUrl = "recipe_quinoa_stir_fry",
                isCloudImage = false
            ),
            Meal(
                ...
                detailImageUrl = "recipe_fruit_salad",
                isCloudImage = false
            ),
            ...
            Meal(
                ...
                carbs = 12,
                fats = 25,
                imageUrl = GitHubImageManager.getImageUrl("chicken_tikka_card.png"),
                detailImageUrl = GitHubImageManager.getImageUrl("chicken_tikka_detail.jpeg"),
                isCloudImage = true
            ),
            Meal(
                name = "Shrimp Tacos",
                ...
                carbs = 45,
                fats = 22,
                imageUrl = GitHubImageManager.getImageUrl("Shrimp Tacos_card.png"),
                detailImageUrl = GitHubImageManager.getImageUrl("Shrimp Tacos_detail.png"),
                isCloudImage = true
            )
        )
        ...
        // Create today's meal plan only if it doesn't exist
        val today = LocalDate.now().toString()
        val existingPlan = getMealPlanByDate(today)
