...
class MealRepository(
    ...
    private suspend fun ensureSevenDayMealPlans() {
        ...
        // All available breakfast meals (IDs: 1, 5, 6, 7, 8, 14, 15)
        val breakfasts = listOf(1L, 5L, 6L, 7L, 8L, 14L, 15L)
        
        // All available lunch meals (IDs: 2, 9, 10, 13, 16, 15, 16)
        val lunches = listOf(2L, 9L, 10L, 13L, 16L, 15L, 17L)
        
        // All available dinner meals (IDs: 3, 12, 11, 19, 18, 11, 17)
        val dinners = listOf(3L, 12L, 11L, 19L, 18L, 11L, 17L)
