...
class MealRepository(
    ...
    suspend fun initializeSampleData() {
        ...
        if (existingMeals.isEmpty()) {
            ...
            // ===== NEW MEALS FROM GITHUB =====
            // Add your uploaded GitHub meals here
            
            // Example: New Lunch Meal
            Meal(
            ...
            // Example: New Dinner Meal
            Meal(
                name = "Beef Stir Fry",
                type = MealType.DINNER,
                description = "Tender beef stir fry with mixed vegetables and rice",
                ...
                carbs = 35,
                fats = 18,
                imageUrl = GitHubImageManager.getDinnerImageUrl("beef_stir_fry_card.png"),
                detailImageUrl = GitHubImageManager.getDinnerImageUrl("beef_stir_fry_detail.png"),
                isCloudImage = true
            ),
            
            // Example: New Snack Meal
            Meal(
                ...
                recipe = "1. Layer yogurt in a glass\n2. Add granola\n3. Top with berries\n4. Drizzle honey",
                calories = 280,
                protein = 20,
                carbs = 35,
                fats = 8,
                imageUrl = GitHubImageManager.getSnackImageUrl("greek_yogurt_parfait_card.png"),
                detailImageUrl = GitHubImageManager.getSnackImageUrl("greek_yogurt_parfait_detail.png"),
                isCloudImage = true
            ),
            
            // ===== ADD YOUR GITHUB MEALS HERE =====
            // Replace the examples above with your actual uploaded meals
            // Make sure the image filenames match exactly what you uploaded to GitHub
        )
    ...
    private suspend fun ensureSevenDayMealPlans() {
        ...
        // Define the 7-day meal plan pattern (cycles through meals)
        val mealPlanPattern = listOf(
            // Day 1 - Today (Breakfast, Lunch, Dinner IDs)
            Triple(1, 2, 3),     // Oatmeal, Grilled Chicken Salad, Quinoa Stir-Fry
            // Day 2 - Tomorrow
            Triple(5, 9, 12),    // Pancake Breakfast, Chicken Tikka, Shrimp Tacos
            // Day 3
            Triple(6, 10, 11),   // Avocado Toast, Grilled Chicken Breast, Salmon & Quinoa
            // Day 4
            Triple(7, 14, 3),    // Acai Bowl, Mediterranean Chicken Salad, Quinoa Stir-Fry
            // Day 5
            Triple(8, 2, 15),    // Keto Breakfast, Grilled Chicken Salad, Beef Stir Fry
            // Day 6
            Triple(1, 9, 11),    // Oatmeal, Chicken Tikka, Salmon & Quinoa
            // Day 7
            Triple(5, 10, 16)    // Pancake Breakfast, Grilled Chicken Breast, Greek Yogurt Parfait
        )
        ...
        for (dayOffset in 0..6) {
            ...
            if (existingPlan == null) {
                val pattern = mealPlanPattern[dayOffset % 7]
                val mealPlan = MealPlan(
                    date = date,
                    breakfastId = pattern.first.toLong(),
                    lunchId = pattern.second.toLong(),
                    lunch2Id = 4,  // Always Fruit Salad Bowl
                    dinnerId = pattern.third.toLong()
                )
