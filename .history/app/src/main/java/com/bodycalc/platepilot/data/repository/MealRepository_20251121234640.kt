...
class MealRepository(
    ...
    private suspend fun ensureSevenDayMealPlans() {
        ...
        // All available lunch meals (IDs: 2, 9, 10, 16, 15, 13, 17)
        val lunches = listOf(2L, 9L, 10L, 16L, 15L, 13L, 17L)
        
        // All available dinner meals (IDs: 3, 12, 11, 19, 18, 17, 16)
        val dinners = listOf(3L, 12L, 11L, 19L, 18L, 17L, 16L)
