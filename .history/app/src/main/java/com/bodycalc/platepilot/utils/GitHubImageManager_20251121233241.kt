...
object GitHubImageManager {
    ...
    fun getBreakfastImageUrl(imagePath: String): String {
        return getImageUrl("breakfast", imagePath)
    }
    
    /**
     * Convenience method for lunch meals
     */
    ...
    /**
     * Convenience method for dinner meals
     */
    fun getDinnerImageUrl(imagePath: String): String {
        return getImageUrl("Dinner_meals", imagePath)
    }
    
    /**
     * Convenience method for snack meals
     */
    fun getSnackImageUrl(imagePath: String): String {
        return getImageUrl("Snack_meals", imagePath)
    }
