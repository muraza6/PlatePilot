...
class MealRepository(
    ...
    private suspend fun ensureSevenDayMealPlans() {
        ...
        // All available lunch meals (IDs: 2, 9, 10, 13, 16, 17, 12 adjusted for variety)
        val lunches = listOf(2L, 9L, 10L, 16L, 13L, 17L, 15L)
        
        // All available dinner meals (IDs: 3, 12, 11, 19, 18, 11, 16 adjusted for variety)
        val dinners = listOf(3L, 12L, 11L, 19L, 18L, 11L, 16L)
        ...
        for (dayOffset in 0..6) {
            ...
            if (existingPlan == null) {
                val mealPlan = MealPlan(
                    ...
                    lunch2Id = 4,  // Always Fruit Salad Bowl (SNACK)
