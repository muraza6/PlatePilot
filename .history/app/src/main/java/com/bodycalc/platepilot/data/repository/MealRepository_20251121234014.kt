...
class MealRepository(
    ...
    suspend fun initializeSampleData() {
        ...
        if (existingMeals.isEmpty()) {
            ...
            Meal(
                ...
                carbs = 45,
                fats = 24,
                imageUrl = GitHubImageManager.getNonVegImageUrl("Döner_Kebab_card.png"),
                detailImageUrl = GitHubImageManager.getNonVegImageUrl("Döner_Kebab_detail.png"),
                isCloudImage = true
            ),
            Meal(
                name = "Fried Rice",
    ...
    private suspend fun ensureSevenDayMealPlans() {
        ...
        val mealPlanPattern = listOf(
            ...
            // Day 4
            Triple(7, 14, 19), // Acai Bowl, Döner Kebab, Spaghetti
            // Day 5
            Triple(8, 15, 18), // Keto Breakfast, Fried Rice, Pasta
            // Day 6
            Triple(14, 9, 11), // Crepes, Chicken Tikka, Salmon & Quinoa
            // Day 7
            Triple(15, 16, 17) // French Toast, Fried Rice, Döner Kebab
        )
