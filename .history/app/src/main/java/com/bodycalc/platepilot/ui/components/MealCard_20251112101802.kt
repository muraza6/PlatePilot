...
fun MealCard(
    ...
    val mealImageRes = when (meal.name) {
        "Oatmeal with Berries" -> R.drawable.oatmeal_berries_new
        "Grilled Chicken Salad" -> R.drawable.grilled_chicken_salad_new
        "Quinoa Stir-Fry" -> R.drawable.quinoa_stir_fry_new
        "Fruit Salad Bowl" -> R.drawable.fruit_salad_bowl_new
        else -> 0
    }
